		...
		<td align="right" valign="bottom">
			<table border="0" cellpadding="0" cellspacing="0" class="headerNav">
				<tr>
					...
					<td></td>
          <td><%=HTMLUtils.createButton(HTMLUtils.HEADER, "autologoffButton", "30", "window.open(\"" + request.getContextPath() + "/scautologoffhelp.jsp\",\"\",\"HEIGHT=250,WIDTH=800,menubar, resizable, scrollbars\");")%></td>
				</tr>
			</table>
		</td>
