              ...
              <td valign="top" >
                <table width="100%" border="0" class="1column">
                  ...
                  <tr>
                    ...
                    you do not navigate to another screen within 30 minutes.  The time remaining in minutes
                    is displayed next to the logoff button.<p>

                    You will be warned 5 minutes before the logout takes place.  If you receive this warning,
