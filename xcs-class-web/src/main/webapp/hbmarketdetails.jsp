...
notes.add(new menuItem("Security Notes","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=70&screen=SCR013&quot;,false)"));
notes.add(new menuItem("Claim Notes","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=80&screen=SCR013&quot;,false)"));
notes.add(new menuItem("Loss Details","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=100&screen=SCR013&quot;,false)"));
notes.add(new menuItem("Policy Details","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=90&screen=SCR013&quot;,false)"));
notes.add(new menuItem("EURO Conversion Details (FME)","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=120&screen=SCR013&quot;,false)"));
notes.add(new menuItem("Broker Additional Details","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=10&screen=SCR013&quot;,false)"));
notes.add(new menuItem("Broker Aggregate Details","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=20&screen=SCR013&quot;,false)"));
notes.add(new menuItem("Slip Lead Comments","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=30&screen=SCR013&quot;,false)"));
notes.add(new menuItem("Lead Comments","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=40&screen=SCR013&quot;,false)"));
notes.add(new menuItem("Lead Additional Detail","submitForm(&quot;<%=request.getContextPath()%>/control/narrative?id=50&screen=SCR013&quot;,false)"));
notesitem.add(notes);
rootmenu.add(notesitem);

rootmenu.add(new menuItem("<%=HTMLUtils.createButton(HTMLUtils.NAVIGATION,"history","newWindow(&quot;" + request.getContextPath() + "/control/history?currentScreen=SCR013&quot;)")%>",""));
...
func.add(new menuItem("Reset Claim Transaction","submitForm(&quot;<%=request.getContextPath()%>/control/resetclaimtransaction?screen=SCR013&quot;)"));
