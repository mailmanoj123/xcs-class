...
<table>
<tr>
<% if (!user.getSchemeCanadaButtonFlag()) { %>
<td><%=HTMLUtils.createButton(HTMLUtils.NAVIGATION,"scheme canada","if (hasLogoffTimer) disableLogoffTimer(); newWindow(&quot;" + request.getContextPath() + "/control/getunmatchedlist&quot;)")%></td>
<% } %>
<% if (user.accountCodeIsXCHU()) { %>
<td><%=HTMLUtils.createButton(HTMLUtils.NAVIGATION,"create new claim","submitForm(&quot;" + request.getContextPath() + "/control/createnewclaim&quot;)")%></td>
<% } %>
<td><%=HTMLUtils.createButton(HTMLUtils.NAVIGATION,"find claim","submitForm(&quot;" + request.getContextPath() + "/control/findclaim&quot;)")%></td>
...
<!-- // BA: 24-11-2003: Settlement search screen -->
<td><%=HTMLUtils.createButton(HTMLUtils.NAVIGATION,"settlement search","newWindow(&quot;" + request.getContextPath() + "/control/settlementsearch&quot;)")%></td>
</tr>
</table>
<script>
HORIZONTAL_X=5;
