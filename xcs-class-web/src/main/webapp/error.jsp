...
function errorOk() {
  if ((window.location + "").indexOf("marketdetails")>-1) {
    ...
    submitForm("<%=request.getContextPath()%>/control/errorok?fromWarning=" + ((window.location + "").indexOf("ignoreWarnings")>-1));
  }
}
</script>
  ...
  <tr>
    ...
    <td class="content">
      ...
      <div class="outerWindow">
				...
				<div class="menuBar"> <%=HTMLUtils.createButton(HTMLUtils.ACTION,"Ok","errorOk()")%>
									...
									<tr>
										...
										<td>
											...
											<table border="0">
												...
												<% 	Enumeration errors = ((ClaimsErrorException)exception).getErrors();
