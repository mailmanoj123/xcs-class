...
public class LZ26Event extends ClaimsEvent implements java.io.Serializable
{
    ...
    public LZ26Event(String XCR, String UCR, String TR, String ORIG_REF_1, String ORIG_REF_2, String ORIG_REF_3, String ORIG_BKR, String SIGNED_IND, String PEER_REV_IND, String PAYEE_BKR,
    ...
    {
        return "java:comp/env/event/LZ26Event";
    }
    ...
    {
        return "com.xchanging.xcc.cics.handlers.LZ26CICSHandler";
    }
