...
public class LY42Event extends ClaimsEvent implements java.io.Serializable {
  ...
  public String getName() {
    return "java:comp/env/event/LY42Event";
  }
  ...
  public String getHandlerName() {
    return "com.xchanging.xcc.cics.handlers.LY42CICSHandler";
  }
