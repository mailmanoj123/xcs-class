...
public class LY53Event extends ClaimsEvent implements java.io.Serializable {
  ...
  public String getName() {
    return "java:comp/env/event/LY53Event";
  }
  ...
  public String getHandlerName() {
    return "com.xchanging.xcc.cics.handlers.LY53CICSHandler";
  }
