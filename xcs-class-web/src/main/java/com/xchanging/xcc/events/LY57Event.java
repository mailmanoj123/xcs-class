...
public class LY57Event extends ClaimsEvent implements java.io.Serializable {
  ...
  public String getName() {
    return "java:comp/env/event/LY57Event";
  }
  ...
  public String getHandlerName() {
    return "com.xchanging.xcc.cics.handlers.LY57CICSHandler";
  }
