...
public class LZ14Event extends ClaimsEvent implements java.io.Serializable {
  ...
  public String getName() {
    return "java:comp/env/event/LZ14Event";
  }
  ...
  public String getHandlerName() {
    return "com.xchanging.xcc.cics.handlers.LZ14CICSHandler";
  }
