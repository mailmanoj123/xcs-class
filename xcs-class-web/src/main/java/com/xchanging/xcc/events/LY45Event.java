...
public class LY45Event extends ClaimsEvent implements java.io.Serializable {
...
//  private String  CASH_COR;
  ...
  private String DIRECT_REPORT_IND = null;
  private String LITIGATION_IND = null;
...
//      String CASH_COR,
...

  {
    ...
    this.ORIG_CURR_HDR = ORIG_CURR_HDR;
    this.COR = COR;
    ...
    if (HPC_VAT_AMT!=null && (HPC_VAT_AMT.equals("") || Double.parseDouble(HPC_VAT_AMT)==0)) {
...
//    this.CASH_COR = CASH_COR;
  ...
  public String getName() {
    return "java:comp/env/event/LY45Event";
  }
  ...
  public String getHandlerName() {
    return "com.xchanging.xcc.cics.handlers.LY45CICSHandler";
  }
  ...
  */
  ...
  public String getORIG_CURR_HDR() {
    return ORIG_CURR_HDR;
  }
