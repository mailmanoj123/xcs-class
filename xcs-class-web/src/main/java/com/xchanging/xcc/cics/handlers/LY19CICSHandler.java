...
public class LY19CICSHandler extends CICSHandler implements java.io.Serializable {

  private MappedRecord results;
  private String fieldHdr = "C019";
  ...
  public void perform(ClaimsEvent ce, StateMachine sm) throws GeneralFailureException, ClaimsErrorException, ClaimsWarningException {
    ...
    LY19Event event = (LY19Event)ce;
    Logger.info("Currency Validation-  LY19 (C019) " + event.getUserSession());
      ...
      try {
         ...
         */
        AttuInteractionSpec iSpeq = new AttuInteractionSpec("ly19");
        iSpeq.setExecutionTimeout(WAIT_TIME);
RecordFactory rf = sm.getRecordFactory();
        MappedRecord queryRecord = rf.createMappedRecord("ly19");

        /**
         * Map the user entered data into the MappedRecord
         */

        queryRecord.put(Keys.LY19_SessionID_Field,Integer.toString(event.getUserSession()));
        queryRecord.put(Keys.LY19_CURR_NO_Field,event.getCURR_NO());
