...
public class LY13CICSHandler extends CICSHandler implements java.io.Serializable {

  private MappedRecord results;
  private String fieldHdr = "C013";
  ...
  public void perform(ClaimsEvent ce, StateMachine sm) throws GeneralFailureException, ClaimsErrorException, ClaimsWarningException {
    ...
    LY13Event event = (LY13Event)ce;
    Logger.info("Build Claim Creation Screen...");
      ...
      try {
         ...
         */
        AttuInteractionSpec iSpeq = new AttuInteractionSpec("ly13");
        iSpeq.setExecutionTimeout(WAIT_TIME);
RecordFactory rf = sm.getRecordFactory();
        MappedRecord queryRecord = rf.createMappedRecord("ly13");

        /**
         * Map the user entered data into the MappedRecord
         */
        queryRecord.put(Keys.LY13SessionIDField,Integer.toString(event.getUserSession()));
