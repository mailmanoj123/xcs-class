...
import com.xchanging.xcc.events.LY50Event;
...
public class LY50CICSHandler extends CICSHandler implements java.io.Serializable {

  private MappedRecord results;
  private String fieldHdr = "C050";
  ...
  public void perform(ClaimsEvent ce, StateMachine sm) throws GeneralFailureException, ClaimsErrorException, ClaimsWarningException {
    ...
    LY50Event event = (LY50Event)ce;
    Logger.info("R/I Schedule Screen D/B Update- LY50 (CO50) " + event.getUserSession());
      ...
      try {
         ...
         */
        AttuInteractionSpec iSpeq = new AttuInteractionSpec("ly50");
        iSpeq.setExecutionTimeout(WAIT_TIME);
RecordFactory rf = sm.getRecordFactory();
        MappedRecord queryRecord = rf.createMappedRecord("ly50");

        /**
         * Map the user entered data into the MappedRecord
         */

        queryRecord.put(Keys.LY50_SessionID_Field,Integer.toString(event.getUserSession()));
