...
public class LZ11CICSHandler extends CICSHandler implements java.io.Serializable {

  private MappedRecord results;
  private String fieldHdr = "C110";
  ...
  public void perform(ClaimsEvent ce, StateMachine sm) throws GeneralFailureException, ClaimsErrorException, ClaimsWarningException {
    ...
    LZ11Event event = (LZ11Event)ce;
    Logger.info(" Create Re-advice Initial Validation- LZ11 (C11O) " + event.getUserSession());
      ...
      try {
         ...
         */
        AttuInteractionSpec iSpeq = new AttuInteractionSpec("lz11");
        iSpeq.setExecutionTimeout(WAIT_TIME);
RecordFactory rf = sm.getRecordFactory();
        MappedRecord queryRecord = rf.createMappedRecord("lz11");

        /**
         * Map the user entered data into the MappedRecord
         */

        queryRecord.put(Keys.LZ11_SESSION_NO ,Integer.toString(event.getUserSession()));
