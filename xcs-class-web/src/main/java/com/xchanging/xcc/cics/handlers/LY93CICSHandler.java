...
public class LY93CICSHandler extends CICSHandler implements java.io.Serializable {

  private MappedRecord results;
  private String fieldHdr = "C093";
  ...
  public void perform(ClaimsEvent ce, StateMachine sm) throws GeneralFailureException, ClaimsErrorException, ClaimsWarningException {
    ...
    LY93Event event = (LY93Event)ce;
    Logger.info("Bring forward from previous transaction " + event.getUserSession());
      ...
      try {
         ...
         */
        AttuInteractionSpec iSpeq = new AttuInteractionSpec("ly93");
        iSpeq.setExecutionTimeout(WAIT_TIME);
RecordFactory rf = sm.getRecordFactory();
        MappedRecord queryRecord = rf.createMappedRecord("ly93");

        /**
         * Map the user entered data into the MappedRecord
         */
        queryRecord.put(Keys.LY93SessionIDField,Integer.toString(event.getUserSession()));
