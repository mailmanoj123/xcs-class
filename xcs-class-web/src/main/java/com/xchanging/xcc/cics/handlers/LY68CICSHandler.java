...
public class LY68CICSHandler extends CICSHandler implements java.io.Serializable {

  private MappedRecord results;
  private String fieldHdr = "C068";
  ...
  public void perform(ClaimsEvent ce, StateMachine sm) throws GeneralFailureException, ClaimsErrorException, ClaimsWarningException {
    ...
    LY68Event event = (LY68Event)ce;
    Logger.info("Set up History Session Record- LY68 (CO68) " + event.getUserSession());
      ...
      try {
         ...
         */
        AttuInteractionSpec iSpeq = new AttuInteractionSpec("ly68");
        iSpeq.setExecutionTimeout(WAIT_TIME);
RecordFactory rf = sm.getRecordFactory();
        MappedRecord queryRecord = rf.createMappedRecord("ly68");

        /**
         * Map the user entered data into the MappedRecord
         */

        queryRecord.put(Keys.LY68_SessionID_Field,Integer.toString(event.getUserSession()));
