...
public class SCMAdviceBackToSchWebHandler extends WebHandler {
...
//                        request.getParameter("cashCorpt1"),
                        ...
                        checkboxValue(request.getParameter("directReportInd")),
                        checkboxValue(request.getParameter("clmInLitigationInd")),
...
//                        request.getParameter("cashCorpt1"),
    ...
    v.add(new LY11Event("SCR017","B","N"));
