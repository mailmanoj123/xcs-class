...
public class LossReserveContinueWebHandler extends WebHandler {
  ...
  public Vector processRequest(HttpServletRequest request) throws ClaimsErrorException {
    ...
    String screenMode = claimModel.getScreenMode() ;

    if (screenMode.toUpperCase().equals("U")) {
