...
public class GroupSearchCorWebHandler extends WebHandler {
  ...
  public Vector processRequest(HttpServletRequest request) throws ClaimsErrorException {
    ...
    v.add(new LY10Event(ucrTrSysRef,currNo,sdnNo,statSplitNo,breakdownNo,"SCR007"));
    v.add(new LY09Event("SCR007"));
    v.add(new LY11Event("SCR007","Y","N"));
