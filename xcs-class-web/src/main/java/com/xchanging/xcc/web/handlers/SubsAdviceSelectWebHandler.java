...
public class SubsAdviceSelectWebHandler extends WebHandler {
  ...
  public Vector processRequest(HttpServletRequest request) throws ClaimsErrorException {
    ...
    int cor = Integer.parseInt(request.getParameter("cor")) - 1;
    ...
    v.add(new LY10Event(subs.getucrTrSysRef(),subs.getcurrNo(),subs.getsdnNo(),
                        subs.getbreakdown(cor).getstatSplitNo(),
                        subs.getbreakdown(cor).getbreakdownNo(),
                        ""));

    v.add(new LY11Event("SCR020","Y","N"));
