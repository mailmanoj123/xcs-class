...
public class NarrativeWebHandler extends WebHandler {
  ...
  public void processSCR012(HttpServletRequest request) {
    ...
    String origBkr              = request.getParameter("origBkr");
...
//                        request.getParameter("cashCorpt1"),
  ...
  public void processSCR021(HttpServletRequest request) {
  }

  public void processSCR022(HttpServletRequest request) {
  }
