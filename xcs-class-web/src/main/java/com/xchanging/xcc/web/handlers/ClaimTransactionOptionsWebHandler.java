...
public class ClaimTransactionOptionsWebHandler extends WebHandler {
  ...
  public Vector processRequest(HttpServletRequest request) throws ClaimsErrorException {
    ...
    if (options.equals("yes")) {
      ...
      } else if (currentScreen.equals("SCR012")) {
        processSCR012(request);
      } else if (currentScreen.equals("SCR013")) {
        processSCR013(request);
      } else if (currentScreen.equals("SCR014")) {
        processSCR014(request);
      } else if (currentScreen.equals("SCR015")) {
        processSCR015(request);
      } else if (currentScreen.equals("SCR016")) {
        processSCR016(request);
      } else if (currentScreen.equals("SCR017")) {
        processSCR017(request);
      } else if (currentScreen.equals("SCR020")) {
        processSCR020(request);
      } else if (currentScreen.equals("SCR021")) {
        processSCR021(request);
      } else if (currentScreen.equals("SCR022")) {
        processSCR022(request);
      } else if (currentScreen.equals("SCR023")) {
        processSCR023(request);
      } else if (currentScreen.equals("SCR024")) {
  ...
  private void processSCR009(HttpServletRequest request) {
  ...
  private void processSCR012(HttpServletRequest request) {
    ...
    String umr                  = request.getParameter("umr");
  ...
  private void processSCR013(HttpServletRequest request) {
  ...
  private void processSCR014(HttpServletRequest request) throws ClaimsErrorException {
  ...
  private void processSCR015(HttpServletRequest request) {
  ...
  private void processSCR016(HttpServletRequest request) {
  ...
  private void processSCR017(HttpServletRequest request) throws ClaimsErrorException {
...
//                        request.getParameter("cashCorpt1"),
  ...
  private void processSCR020(HttpServletRequest request) {
  ...
  private void processSCR021(HttpServletRequest request) {

  }

  private void processSCR022(HttpServletRequest request) {
    ModelManager mm = (ModelManager)request.getSession().getAttribute(Keys.ModelManagerKey);
    ...
    v.add(new LY82Event("",ccys.elements()));
  }

  private void processSCR023(HttpServletRequest request) {
    v.add(new LY65Event(false,"","","","","","","","V"));
  }

  private void processSCR024(HttpServletRequest request) {
